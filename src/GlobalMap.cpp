#include "GlobalMap.h"
list<BBNode> BBNode::getC0(const double T_WINDOW,const double R_WINDOW,const double T_RES,const double R_RES,double x,double y,double th,Eigen::MatrixXd *points,ProbMap *map){
	list<BBNode> res;
